...
let smallImgs = Array.from(document.querySelectorAll('.small-img-col img')); 
...
async function getFeutredProductsData () {
    ...
    createProductDetail(responeData);
    createDetail(responeData); 
    console.log(createDetail(responeData))
